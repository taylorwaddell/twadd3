...
export const Shaka: React.FC = () => {
  return (
    ...
    >
      ...
      <path d="m790.09,106.76s-21.61,31.17-31.5,52.14c-9.89,20.96-46.98,37.62-21.71,51.6,25.26,13.97,61.27-34.4,80.08-8.6,18.81,25.8,21.5,13.97,22.04-7.52.54-21.5,66.65-69.87,67.72-87.61,1.07-17.74-16.66-37.09-39.77-31.71,0,0-23.66-41.39-49.45-15.59-25.79,25.8-14.82,28.23-27.41,47.3Z" />
...
export const X: React.FC = () => {
  return (
    <svg aria-hidden="true" className="social-icon" id="x-icon">
      <g>
...
export const CTAArrow: React.FC = () => {
  return (
    <svg
      aria-hidden="true"
      width="11"
